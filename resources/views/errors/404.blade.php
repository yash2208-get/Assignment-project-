...
h2{
  ...
  text-shadow: 0px 0px 4px #1e3b03;
...
@keyframes flicker4{
  0%  {color: #553742;text-shadow:0px 0px 4px #553742;}
  30% {color: #553742;text-shadow:0px 0px 4px #553742;}
  31% {color: #1e3b03;text-shadow:0px 0px 4px #1e3b03;}
  32% {color: #553742;text-shadow:0px 0px 4px #553742;}
  36% {color: #553742;text-shadow:0px 0px 4px #553742;}
  37% {color: #1e3b03;text-shadow:0px 0px 4px #1e3b03;}
  41% {color: #1e3b03;text-shadow:0px 0px 4px #1e3b03;}
  42% {color: #553742;text-shadow:0px 0px 4px #553742;}
  85% {color: #553742;text-shadow:0px 0px 4px #553742;}
  86% {color: #1e3b03;text-shadow:0px 0px 4px #1e3b03;}
  95% {color: #1e3b03;text-shadow:0px 0px 4px #1e3b03;}
  96% {color: #553742;text-shadow:0px 0px 4px #553742;}
  100%{color: #553742;text-shadow:0px 0px 4px #553742;}
}

@keyframes fadeInText{
  1%  {color: #1e3b03;text-shadow:0px 0px 4px #1e3b03;}
  70% {color: #553742;text-shadow:0px 0px 14px #553742;}
  100%{color: #553742;text-shadow:0px 0px 4px #553742;}
}
